...
export function articleBodyPrompt(
  ...
  return [
    ...
    "• KEEP every existing section heading exactly as written UNLESS you are",
    "  ONLY changing it to match a target query and the section's body already",
    "  covers that topic. Never delete or merge sections.",
